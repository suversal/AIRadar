...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <div aria-label="明暗主题" className="flex items-center gap-1" role="radiogroup">
      ...
      <div aria-label="主题色" className="flex items-center gap-1" role="radiogroup">
        {COLOR_PALETTES.map(({ value, label, swatch }) => {
