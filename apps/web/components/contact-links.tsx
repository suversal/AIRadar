...
function ContactLink({
  ...
  return (
    <a
      ...
      className="inline-flex h-8 w-8 items-center justify-center text-ink-dim transition-colors hover:text-signal focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-signal"
      href={href}
  ...
  return (
    <nav aria-label="联系方式" className="flex items-center justify-center gap-1.5">
      ...
      <ContactLink href="mailto:contact@suversal.com" label="发送邮件">
        <Mail aria-hidden className="h-4 w-4" strokeWidth={1.7} />
      </ContactLink>
